                    ...
                    <form className='modal-content flex align-center'>
                        ...
                        {currModalView !== 'default' &&
                            <div className='form-controls flex space-between'>
                                <button className='back-btn' onClick={() => this.changeModalView('default')}>Back</button>
                                {(currModalView === 'joinServer')
                                    ? <button className='submit-btn' onClick=''>Join server</button>
                                    : <button className='submit-btn' onClick={this.createServer} >Create</button>}
                            </div>
                        }
                    </form>
